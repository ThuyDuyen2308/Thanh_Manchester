...
namespace PhanMemQuanLyQuanCaffe
{
    public partial class frmChuyenBan : Form
    {
        ...
        private void LoadBanNguon()
        {
            ...
            cboBanNguon.Items.Clear();
            foreach (DataRow r in dt.Rows)
                cboBanNguon.Items.Add(r["MaBan"].ToString().Trim());
            if (cboBanNguon.Items.Count > 0)
                cboBanNguon.SelectedIndex = 0;
        }
        ...
        private void cboBanNguon_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string maBan = cboBanNguon.SelectedItem.ToString();
